...
const SearchResult = () => {
    ...
    const { imageSearch } = useContext(Context); //Accessing from global res 
    ...
    const fetchSearchResults = () => {
        ...
        if (imageSearch) { // If user click on image search the add this to payload 
            payload.searchType = "image"; 
        }
        fetchDataFromApi(payload).then((res) => {
            setResult(res); //Set the global state
        });
    };
